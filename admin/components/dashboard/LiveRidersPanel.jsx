// admin/components/dashboard/LiveRidersPanel.jsx
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-3 sm:space-y-0">
          ...
          <div className="relative">
            <input
              ...
              className="pl-10 pr-4 py-2 w-full sm:w-48 bg-slate-800/50 border border-slate-700 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
            />
